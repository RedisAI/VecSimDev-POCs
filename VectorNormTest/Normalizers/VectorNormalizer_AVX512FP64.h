...
#include <vector>
#define MAX_RESIDUAL 7
#define VECT_TYPE double
#define NAME AVX512FP64
struct Naive
{   
    ...
    static  void Normalize(const void* v,size_t dim)
    {
        Naive_Normalizer<residual,double>((double*)v,dim);        
    }
};
